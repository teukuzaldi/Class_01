...
if not os.path.exists(theworkspace):
    print("Failed: Landsat_data_lfs is not contain in the Class_10 folder\n" +
          "Extract the Landsat_data_lfs into the Class_10 to resolve this")
else:
