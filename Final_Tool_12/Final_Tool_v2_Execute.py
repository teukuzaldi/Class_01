...
class NDVI_Calculator(object):
    ...
    def getParameterInfo(self):
        ...
        Input_Band4.value = r"D:\NRS528_Python\NRS528\Final_Tool_12\Landsat_data_lfs\201502\LC08_L1TP_012031_20150201_20170301_01_T1_B4.tif" # This is a default value that can be over-ridden in the toolbox
        ...
        Input_Band5.value = r"D:\NRS528_Python\NRS528\Final_Tool_12\Landsat_data_lfs\201502\LC08_L1TP_012031_20150201_20170301_01_T1_B5.tif" # This is a default value that can be over-ridden in the toolbox
        ...
        NDVI_Output.value = r"D:\NRS528_Python\NRS528\Final_Tool_12\Test_Result_candelete\NDVI1tools.tif" # This is a default value that can be over-ridden in the toolbox
...
def main():
    tool = NDVI_Calculator() # i.e. what you have called your tool class: class Clippy(object):
...
class DSM_Creator_Tool(object):
    ...
    def getParameterInfo(self):
        ...
        Input_LAS_DSM.value = r"D:\NRS528_Python\NRS528\Final_Tool_12\LAS_URI\19_02884594.las" # This is a default value that can be over-ridden in the toolbox
        ...
        Output_DSM.value = r"D:\NRS528_Python\NRS528\Final_Tool_12\Test_Result_candelete\DSM2tools.tif" # This is a default value that can be over-ridden in the toolbox
...
def main():
    tool = DSM_Creator_Tool() # i.e. what you have called your tool class: class Clippy(object):
    tool.execute(tool.getParameterInfo(), None)
...
class DHM_Creator_Tool(object):
    ...
    def getParameterInfo(self):
        ...
        Input_LASDSM.value = r"D:\NRS528_Python\NRS528\Final_Tool_12\LAS_URI\19_02884594.las" # This is a default value that can be over-ridden in the toolbox
        ...
        Input_DEM.value = r"D:\NRS528_Python\NRS528\Final_Tool_12\DEM_URI\19_02884594.img" # This is a default value that can be over-ridden in the toolbox
        ...
        Output_DSM.value = r"D:\NRS528_Python\NRS528\Final_Tool_12\Test_Result_candelete\DSM3TOOLS.img" # This is a default value that can be over-ridden in the toolbox
        params.append(Output_DSM)
        ...
        Output_DHM.value = r"D:\NRS528_Python\NRS528\Final_Tool_12\Test_Result_candelete\DHM3tools.img" # This is a default value that can be over-ridden in the toolbox
...
def main():
    tool = DHM_Creator_Tool() # i.e. what you have called your tool class: class Clippy(object):
    tool.execute(tool.getParameterInfo(), None)
