...
# InputFileName = r'C:\Shapefile.shp' # don't just use X to name file, better name it at the beginning
# print(InputFileName)

# # This is not valid, as variables cannot start with a number nor can they contain spaces:
# x1 = r'C:\Shapefile.shp' # it cannot number 1st, no space, etc
# print(x1)
...
#
# # String
# example_string = 'this is a string, it can store anything... Well almost' # don't use slice or other symbol
# # example_string = 'you cannot use the same 'quote' mark within a string' # use double quote if the string use single
...
# example_string = 'this is a string, but I would be anyway without str()'
...
#
# example_join_string = example_string + ' ' + str(2) + '.. Magic!' # str doesnt do math, int or float will do
#
# # Integer
# example_integer = 2
...
# print(my_first_list[4]) #Note that zero notation, 0 = first item in list
# #
...
# number_list = [1, 3, 4, 2, 10, 8, 5, 13, 12]
...
my_second_dictionary = { 1 : [{'Distance': '23', 'Density':'9'}],
                         2 : [{'Distance': '50', 'Density':'10'}],
                         3 : [{'Distance': '12', 'Density':'3'}] }
