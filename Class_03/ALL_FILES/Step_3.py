...
# file = open("testfile.txt", "w") #'w' will create new one and destroy the previous
#
...
# file.write("geby, I am a line added later\n")
# file.close()
#
...
# file = open("Task_Step_3.txt", "r")
# file_contents = file.readlines()
# counter = 1
# for i in file_contents:
#     if i.rstrip() == 'Zebra':
#         print(str(counter) + ": " + i.rstrip())
#     elif i.rstrip() == 'Limpet':
#         print(str(counter) + ": " + i.rstrip())
#     elif i.rstrip() == 'Mongoose':
#         print(str(counter) + ": " + i.rstrip())
#     elif i.rstrip() == 'Spider monkey':
#         print(str(counter) + ": " + i.rstrip())
#     counter = counter + 1
# file.close()
